	...
	local changelog = {
		{
			stamp = "2024-5-30",
			data = {
				"Codex Tiếng Việt lần đầu ra mắt"
				 }
				}
			};
...
do
	framework.data.builtInScripts = {
		{
			title = "Dark Dex V4",
			description = "GUI khám phá trò chơi mạnh mẽ. Hiển thị mọi phiên bản của trò chơi và tất cả thuộc tính của chúng. Hữu ích cho các nhà phát triển.",
		...
		{
			title = "Unnamed ESP",
			description = "Trình phát ESP cho Roblox, hoàn toàn không thể bị phát hiện, sử dụng API bản vẽ tích hợp.",
		...
		{
			title = "Giang MC Hub",
			description = "Best Script Slap Battles",
			icon = "rbxassetid://14806221310",
			content = "pcall(function() loadstring(game:HttpGet(\"https://raw.githubusercontent.com/tanhoangviet/slap-battles/main/77_NZT2KP8S2Z3K92.lua.txt?token=GHSAT0AAAAAACNOE7XTIGDQOWWZCU75HWPOZPUHDMQ\"))(); end);"
		},
		{
			title = "Hydroxide",
			description = "Công cụ kiểm tra bút đa năng dành cho trò chơi trên công cụ Roblox",
		...
		},
		{
			...
			description = "Tập lệnh dòng lệnh quản trị viên với hơn 300 lệnh và 6 năm phát triển",
		...
		{
			title = "Owl Hub",
			description = "Owl Hub là một trung tâm tập lệnh Roblox miễn phí được phát triển bởi Google Chrome và CriShoux. Nó hiện có hơn 30 trò chơi.",
	...
	local map = {
		{
			...
			items = {
				{
					title = "tự động hoạt động",
					linkedSetting = "executor.autoExecute",
					optionType = "toggle",
					state = true
				},
				{
					title = "Lưu giữ script của bạn",
		...
		{
			title = "Máy chủ hợp tác",
			items = {
				{
					title = "Ưu tiên máy chủ",
					linkedSetting = "serverHop.priority",
					optionType = "dropdown",
					items = { "Nhiều người chơi nhất", "Ít người chơi nhất", "Ping tốt nhất", "Ngẫu nhiên" }
				},
				{
					title = "Máy chủ hợp tác",
					optionType = "button",
				...
				{
					title = "Tham gia lại máy chủ hiện tại",
					optionType = "button",
					callback = function()
		...
		return instanceUtils:Create("Frame", { 
			...
			instanceUtils:Create("ScrollingFrame", { 
				...
				textButton({
					BackgroundColor3 = Color3.fromRGB(58, 58, 74), 
					Name = "builtInLibrary", 
					Text = "Thư viện tích hợp",
					TextColor3 = Color3.fromRGB(159, 164, 186)
				}),
				textButton({
					BackgroundColor3 = Color3.fromRGB(58, 58, 74), 
					Name = "savedScripts", 
					Text = "Tập lệnh đã lưu",
					TextColor3 = Color3.fromRGB(159, 164, 186)
				})
			}),
			instanceUtils:Create("Folder", { 
