...
local function CreateImageButtonToHideAndDestroy()
    ...
    -- Tạo ImageButton
    local imageb = Instance.new("ImageButton")
    imageb.Size = UDim2.new(0, 60, 0, 60)
    imageb.Position = UDim2.new(0.5, -30, 0.5, -170)
    imageb.BackgroundColor3 = Color3.fromRGB(65, 65, 65)
    imageb.Image = "rbxassetid://7734053495"
    imageb.ImageTransparency = 0
    imageb.BackgroundTransparency = 0
    imageb.Parent = gui

    -- Tạo UICorner và UIStroke cho ImageButton
    local imagec = Instance.new("UICorner")
    imagec.CornerRadius = UDim.new(0, 40)
    imagec.Parent = imageb

    local images = Instance.new("UIStroke")
    images.Color = Color3.new(0, 0, 0)
    images.Thickness = 2
